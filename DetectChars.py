...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt("KNN/Classifications.txt", np.float32)                  # read in training classifications
    ...
    try:
        npaFlattenedImages = np.loadtxt("KNN/Flattened_images.txt", np.float32)                 # read in training images
    except:                                                                                 # if file could not be opened
